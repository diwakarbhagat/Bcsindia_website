...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="upload/logo.png" >
    <title>About : Be Confident Solutions Orai, OT Beds, OT Table, OT Light, Hospital Furniture, Hospital Beds, Hospital Doors, X-ray machine, Medical Devices, CT Scan Machine, MRI Machine, Couche, Sidetable, Ambulance Customizati </title>
      ...
      ?>
                        ...
                        <div class="header-nav navbar-collapse collapse ">
                            <ul class=" nav navbar-nav">
                                ...
                                <li class="active"><a href="about_bcs_india">About Us</a></li>
          ...
          <div class="section-full bg-gray p-t100 p-b70 bg-repeat" style="background-image:url(images/background/bg-6.jpg);">
                 <div class="container ">
                    <div class="section-head text-center">
                        <h1 ><span class="site-text-primary" ></span><?php echo $row['heading'] ?></h1>
