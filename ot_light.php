...
<head>
    ...
    <title> OT Light : Be Confident Solutions Orai, OT Beds, OT Table, OT Light, Hospital Furniture, Hospital Beds, Hospital Doors, X-ray machine, Medical Devices, CT Scan Machine, MRI Machine, Couche, Sidetable, Ambulance Customizati </title>
            ...
            <div class="bg-gray-light p-tb20">
                <div class="container">
                    <ul class="wt-breadcrumb breadcrumb-style-2">
                        ...
                        <li><a href="ot_light">OT Light</li>
                    </ul>
                </div>
            </div>
            <!-- BREADCRUMB ROW END -->
           ...
           <div class="section-full bg-gray p-t100 p-b70 bg-repeat" style="background-image:url(images/background/bg-6.jpg);">
                <div class="container">
                    ...
                    <div class="section-head text-center">
                      <h1 style="color: #adc33c;"><span class="site-text-primary">OT </span>Light</h1>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box">
                                    <div class="wt-media text-primary m-b20 radius-bx circle-effect-1">
                                       <a href="ot_light_portfolio"><img src="upload/<?php echo $row['image']; ?>" style="height: 322px; width: 422px;"  class="radius-bx"  alt=""></a>
                                    </div>
                                    <div class="wt-info p-t30 text-center">
                                        <h4 class="m-b0"><a href="ot_light_portfolio"><?php echo $row['name']; ?></a></h4><br>
                                         ...
                                         <a href="ot_light_portfolio" target="_blank"  class="m-b0" style="text-align: center; fornt-size: 20px;">OT Light Portfolio</a>
                                    </div>
                                </div>
                            </div>
              <?php
