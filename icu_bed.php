...
<head>
    ...
    <title>ICU Bed: Be Confident Solutions Orai, OT Beds, OT Table, OT Light, Hospital Furniture, Hospital Beds, Hospital Doors, X-ray machine, Medical Devices, CT Scan Machine, MRI Machine, Couche, Sidetable, Ambulance Customizati </title>
      ...
      ?>
                        ...
                        <div class="header-nav navbar-collapse collapse ">
                            <ul class=" nav navbar-nav">
                                ...
                                <li active="active"><a href="bcs_india_products">Products</a></li>
           ...
           <div class="section-full bg-gray p-t100 p-b70 bg-repeat" style="background-image:url(images/background/bg-6.jpg);">
                <div class="container">
                    ...
                    <div class="section-head text-center">
                      <h1 style="color: #adc33c;"><span class="site-text-primary">ICU </span>Bed</h1>
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box">
                                    <div class="wt-media text-primary m-b20 radius-bx circle-effect-1">
                                       <a href="icu_bed_portfolio"><img src="upload/<?php echo $row['image']; ?>" style="height: 322px; width: 422px;"  class="radius-bx"  alt=""></a>
                                    </div>
                                    <div class="wt-info p-t30 text-center">
                                        <h4 class="m-b0"><a href="icu_bed_portfolio"><?php echo $row['name']; ?></a></h4><br>
                                         ...
                                         <a href="icu_bed_portfolio" target="_blank"  class="m-b0" style="text-align: center; fornt-size: 20px;">ICU Bed Portfolio</a>
                                    </div>
                                </div>
                            </div>
              <?php
