...
<head>
    ...
    <title> Laproscopy Portfolio: Be Confident Solutions Orai, OT Beds, OT Table, OT Light, Hospital Furniture, Hospital Beds, Hospital Doors, X-ray machine, Medical Devices, CT Scan Machine, MRI Machine, Couche, Sidetable, Ambulance Customizati </title>
      ...
      ?>
        ...
        <div class="page-content">
            ...
            <div class="wt-bnr-inr overlay-wraper" style="background-image:url(images/banner/product-banner.jpg);">
                ...
                <div class="container">
                    <div class="wt-bnr-inr-entry">
                        <h1 class="text-white">Laproscopy Portfolio</h1>
                    </div>
                </div>
            </div>
           ...
           <div class="section-full p-t80 p-b50">
                ...
                include('connection.php');
                $a=1;
                $query="select * from laparoscopy_portfolio";
