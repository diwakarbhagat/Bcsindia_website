...
<head>
    ...
    <title> Certificate : Be Confident Solutions Orai, OT Beds, OT Table, OT Light, Hospital Furniture, Hospital Beds, Hospital Doors, X-ray machine, Medical Devices, CT Scan Machine, MRI Machine, Couche, Sidetable, Ambulance Customizati </title>
                        ...
                        <div class="header-nav navbar-collapse collapse ">
                            <ul class=" nav navbar-nav">
                                ...
                                <li><a href="bcs_india_media">Media</a></li>
                                 ...
                                 <li class="active"><a href="certificate">Certificate</a></li>
                            </ul>
                        </div>
                        <div class="extra-nav">                         
        ...
        <div class="wt-bnr-inr overlay-wraper" style="background-image:url(images/banner/product-banner.jpg);">
            ...
            <div class="container">
                <div class="wt-bnr-inr-entry ">
                    <h1 class="text-white text-center">Certificate</h1>
                </div>
            </div>
        </div>
        <!-- bredcome end -->
              ...
              $a=1;
               ...
               ?>
                            ...
                            <div class="col-lg-6 col-md-6 text-center">
                                       ...
                                       <a href=""><img src="upload/<?php echo $row['image']; ?>" style="height: 322px; width: 422px;"   alt=""></a>
                                    
                                    <div class="wt-info  mt-2 ">
                                        <h4 class="btn"><a href=""><?php echo $row['name']; ?></a></h4><br>
