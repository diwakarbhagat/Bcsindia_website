...
<head>
    ...
    <title> OT Bed: Be Confident Solutions Orai, OT Beds, OT Table, OT Light, Hospital Furniture, Hospital Beds, Hospital Doors, X-ray machine, Medical Devices, CT Scan Machine, MRI Machine, Couche, Sidetable, Ambulance Customizati </title>
          ...
          <div class="section-full bg-gray p-t100 p-b70 bg-repeat" style="background-image:url(images/background/bg-6.jpg);">
                <div class="container">
                    ...
                    <div class="section-head text-center">
                      <h1 style="color: #adc33c;"><span class="site-text-primary">OT </span>bed</h1>
                        ...
                        <p>Gusseted bags have V type bottom. Mostly used for Groceries, Fast Food, Snacks, Namkeen etc.</p>
                    </div>
                    <!-- TITLE END-->
                            ...
                            <div class="col-md-4 col-sm-4 p-tb15">
                                <div class="wt-box">
                                    <div class="wt-media text-primary m-b20 radius-bx circle-effect-1">
                                       <a href="ot_bed_portfolio"><img src="upload/<?php echo $row['image']; ?>" style="height: 322px; width: 422px;" class="radius-bx"  alt=""></a>
                                    </div>
                                    <div class="wt-info p-t30 text-center">
                                        <h4 class="m-b0"><a href="ot_bed_portfolio"><?php echo $row['name']; ?></a></h4><br>
                                         <h4 class="m-b0"><a href="https://api.whatsapp.com/send?phone=+918737854494" >
                                            <img src="images/whatsappicon_gargi_paperkraft_lko.png" style="width: 90px; height: auto;"></a></h4><br>
                                         <a href="ot_bed_portfolio" target="_blank"  class="m-b0" style="text-align: center; fornt-size: 20px;">OT Bed Portfolio</a>
                                    </div>
                                </div>
                            </div>
              <?php
